...
<div class="row">
			<div class="span8">
				...
				<div class="widget-header">
					<h3><i class="icon-pencil"></i>EDIT DATA DOSEN</h3>
					
					<div class="widget-actions">
						<div class="btn-group">
						<a class='btn btn-small btn-danger' href="go-dosen.html"><i class="icon-undo"></i> Kembali</a>
				          <button class="btn btn-small dropdown-toggle" data-toggle="dropdown">Menu <span class="caret"></span> </button>
				          <ul class="dropdown-menu">
				            <li><a href="actions-dosen-pendidikan-1-<?php echo $id;?>.html"><i class="icon-plus"></i>Tambah Pendidikan </a></li>
				            <li><a href="actions-dosen-pekerjaan-1-<?php echo $id;?>.html"><i class="icon-plus"></i>Tambah Pekerjaan </a></li>
							<li><a href="actions-dosen-penelitian-1-<?php echo $id;?>.html"><i class="icon-plus"></i>Tambah Penelitihan </a></li>
				            <li class="divider"></li>
				            <li><a href="get-print-Dosen-<?php echo $id;?>.html?lightbox[iframe]=true&ui-lightbox[width]=75p&ui-lightbox[height]=75p" class="ui-lightbox"><i class="icon-print"></i>Print Detail </a></li>
				          </ul>
				        </div>					
					</div> 
				</div> 
...
<div class='control-group'>
	...
	<div class='controls'>
		<input type='text' name='NIDN' value='$r[NIDN]' class='input-xlarge'>
	</div>
</div>
<div class='control-group'>
...
<div class='control-group'>
	...
	<div class='controls'>
		<input type='text' name='Homebase' value='$r[Homebase]'>
	</div>
</div>
<div class='control-group'>
	<label class='control-label'>SK Pengangkatan</label>
	<div class='controls'>
		<input type='text' name='Skpengankatan' value='$r[Skpengankatan]'>
	</div>
</div>
<div class='control-group'>
...
<div class='control-group'>
	...
	<div class='controls'>
	<input type='text' name='Keilmuan' value='$r[Keilmuan]'>
	</div>
</div>"; 
?>
...
<thead>
	<tr>
	<th>No</th><th>Gelar</th><th>Jenjang</th><th>Tanggal Lulus</th><th>Perguruan Tinggi</th><th>Negara</th><th>Bidang Ilmu</th><th><center>Aksi</center></th></tr>
</thead>
<tbody>
<?php 
...
echo "<tr>
		...
		<td>
			<center>
				<a class='btn btn-mini btn-primary' href='actions-dosen-pendidikan-0-$ra[DosenPendidikanID].html'><i class='icon-pencil'></i> Edit</a>
				<a class='btn btn-mini btn-danger' href='actions-dosen-delpendidikan-$id-$ra[DosenPendidikanID].html' onClick=\"return confirm('Apakah Anda benar-benar akan menghapus Gelar $ra[Gelar] ?')\"><i class='icon-trash'></i> Hapus</a>
			</center>
		</td>
	</tr>";
	$no++;
...
<table class="table table-striped">
<thead>
	<tr><th>No</th><th>Jabatan</th><th>Institusi</th><th>Alamat</th><th>Telepon</th><th><center>Aksi</center></th></tr>
</thead><tbody>
<?php
...
if(_num_rows($tampil) > 0){
	...
	echo "<tr><td>$no</td>
			...
			<td>
				<center>
					<a class='btn btn-mini btn-primary' href='actions-dosen-pekerjaan-0-$ra[DosenPekerjaanID].html'><i class='icon-pencil'></i> Edit</a>
					<a class='btn btn-mini btn-danger' href='actions-dosen-delpekerjaan-$id-$ra[DosenPekerjaanID].html' onClick=\"return confirm('Apakah Anda benar-benar akan menghapus Data Pekerjaan $ra[Jabatan] ?')\"><i class='icon-trash'></i> Hapus</a>
				</center>
			</td></tr>";
	$no++;
	} 
...
if(_num_rows($tampil) > 0){
 ...
 ?>
	...
	<div class='widget-toolbar'>
		<center>
		<input class='btn btn-success btn-large' type='submit' name='UpdateDosen' value='Update Data Dosen'>
		</center>
	</div>
</form>
...
<div class="span4">
	<div class="widget widget-table toolbar-bottom">
		<div class="widget-header">
			<h3><i class="icon-info-sign"></i><?php echo strtoupper($r['nama_lengkap']); ?></h3>		    			
		</div>
