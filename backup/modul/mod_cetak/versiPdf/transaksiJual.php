...
$brg = GetFields('transaksijual', 'Notrans', $trans, '*');
$Pembeli=$brg['userid'];
if($d['ProdukId']==4){
            ...
            <td style='width: 100%'>
                <div class='zone' style='height: 28mm;position: relative;font-size: 5mm;'>
					...
					<div style='position: absolute; right: 3mm; top: 3mm; text-align: right; font-size: 4mm; '>
                        <i>PENJUALAN BARANG - ID : $trans</i><br><br><br>
						<span><i>Tanggal : $tglTransaksi</i></span><br><br>
						<span><i> Pembeli : $Pembeli</i></span><br>
                    </div>
...
echo"<tr>
		<td style='width: 40%; text-align: left' >$b[NamaInventaris] Ukuran $ukr</td>
		<td style='width: 20%; text-align: right'>$brg[Jumlah] $b[Satuan]</td>
		<td style='width: 40%; text-align: right'>$harga</td>
	</tr>";
}else{
echo"<tr>
		<td style='width: 40%; text-align: left' >Penjualan $b[NamaInventaris]</td>
		<td style='width: 20%; text-align: right'>$brg[Jumlah] $b[Satuan]</td>
		<td style='width: 40%; text-align: right'>$harga</td>
	</tr>";
}
