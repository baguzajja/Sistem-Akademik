...
$brg = GetFields('transaksipakai', 'Notrans', $trans, '*');
$Pembeli=$brg['userid'];
            ...
            <td style='width: 100%'>
                <div class='zone' style='height: 28mm;position: relative;font-size: 5mm;'>
					...
					<div style='position: absolute; right: 3mm; top: 3mm; text-align: right; font-size: 4mm; '>
                        <i>PEMAKAIAN BARANG - ID : $trans</i><br><br><br>
						<span><i>Tanggal : $tglTransaksi</i></span><br><br>
...
echo"<table cellspacing='0' style='width: 100%; border: solid 1px #208bbd; background: #208bbd; font-size: 10pt; color: #FFF;'>
        <tr>
            ...
            <th style='width: 20%; text-align: right'>UNTUK</th>
            <th style='width: 40%; text-align: right'>QTY</th>
        </tr>
    </table>";
	
echo"<table cellspacing='0' style='width: 100%; border: solid 1px #F7F7F7; background: #F7F7F7; font-size: 10pt;'>";
echo"<tr>
		<td style='width: 40%; text-align: left' >Pemakaian $b[NamaInventaris]</td>
		<td style='width: 20%; text-align: right'>$Pembeli</td>
		<td style='width: 40%; text-align: right'>$brg[Jumlah] $b[Satuan]</td>
	</tr>";
echo"</table>";
...
echo"<table cellspacing='0' style='width: 100%; border: solid 1px #FFF; background: #FFF; text-align: center; font-size: 10pt; color: #333;'>
        <tr>
            ...
            <th style='width: 40%; text-align: right;'>$brg[Jumlah] $b[Satuan]</th>
        </tr>
    </table>";
echo"</td></tr>";
