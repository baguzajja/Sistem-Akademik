...
<table id=tablemodul1>
	<tr>
      <td class=basic><strong>Nama</strong></td>
      <td class=basic><strong> $d[Nama] </td>
	</tr>
    <tr>
      <td class=basic><strong>NIM</strong></td>
      <td class=basic><strong> $d[NIM]</td>
    </tr>
    <tr>
      <td class=basic><strong>Program Studi</strong></td>
      <td class=basic><strong> $d[kode_jurusan] - $prodi</strong></td>
    </tr>
  </table>
	  </td>
...
echo"<table id=tablestd class=box>
...
echo"</div>";
echo"<br/>";
$ka="select * from karyawan WHERE Bagian='YPN05' AND kode_jurusan='$d[kode_jurusan]'";
$pro=_query($ka) or die();
$kp=_fetch_array($pro);	
echo"<table class='' width='100%'>
    <tr>
      <td width='60%' align='left'>
...
<table id=>
  <tr>
	...
	<tr>
    <td> <center><strong>( KA. PRODI )</strong></center></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
<tr>
  ...
  <tr>
    <td> <center><strong>( $kp[nama_lengkap] )</center></td>
  </tr>
</table>
	  </td>    
    </tr>
