...
table.ket th {
    padding:1px;
	background-image: url(../yapan/style/images/hbg.gif);
...
<page backtop='0' backbottom='0' backleft='2mm' backright='2mm' style='font-size: 12pt'>
    <page_header>
        <table class="page_header">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                   Semester <?php echo $NamaSemester; ?>
                </td>
            </tr>
        </table>
    </page_header>
...
$filename="kalender-akademik".$NamaTahun;
$content = ob_get_clean();
	...
	$html2pdf->createIndex('', 30, 12, false, false, 1);
