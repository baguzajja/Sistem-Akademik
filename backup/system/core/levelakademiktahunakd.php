...
<?php
function deflevelakademiktahunakd(){
...
buka("BAAK :: Kalender Akademik stie yapan Surabaya");
echo "<div class='row-fluid'>
		<div class='input-prepend input-append  pull-left'>
	<form action='go-levelakademiktahunakd.html' method='post'>
