...
buka("Kartu Hasil Studi (KHS)");  
echo "<form method=post action='go-akademikkhs.html'>
...
echo"<legend>DATA KHS SEMESTER $namaSemester ( $semester )
	...
	<a class='btn btn-inverse iframe' href='Kpdf-khs-$tahun-$semester-$nim.html' title='CETAK KHS'>Cetak</a>
	</div></legend>";
