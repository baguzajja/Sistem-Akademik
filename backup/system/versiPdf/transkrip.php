...
<tr>
			...
			<th style='width: 30%; border: solid 1px #EEE; background-color:#fff; text-align:center;'><b style='text-align:left;'>NO : T &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</b><b style='text-align:right;'>- $getNim/STY-TS/$getBr/$TahunIni  </b></th>
			<th style='width: 35%;'>&nbsp;</th>
		</tr>
</table>
...
$nfo=1;
 $sql="SELECT * FROM matakuliah WHERE Identitas_ID='$_SESSION[Identitas]' AND Jurusan_ID='$w[kode_jurusan]' AND Kurikulum_ID IN ($Kons,$w[Kurikulum_ID]) ORDER BY Semester, Matakuliah_ID";
  ...
  while($data=mysql_fetch_array($qry)){
	$sqlr="SELECT * FROM krs WHERE NIM='$id' AND Jadwal_ID='$data[Matakuliah_ID]'";
