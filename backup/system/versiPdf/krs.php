...
echo"<table style='width: 100%; font-weight: bold;color:#213699; cellpadding:2px;'>
		...
		<tr>
            ...
            <td style='width: 20%;'>&nbsp;</td>
			<td colspan='3' style='width:40%; border: solid 1px #EEE; background-color:#fcfcfc; text-align:center;'>$NamaTahun</td>
		...
		<tr>
            ...
            <td style='width: 20%;'>&nbsp;</td>
			<td colspan='3' style='width:40%; border: solid 1px #EEE; background-color:#fcfcfc; text-align:center;'>SEMESTER $namaSemester ( $semester )</td>
...
echo"<br><br><br><table style='width: 100%;color:#444;font-weight: bold;'>
            <tr>
				...
				<td style='width:20%;border-bottom:1px dashed #000000;'></td>
				 <td style='width:40%;border-bottom:1px dashed #000000; text-align:center;'>Surabaya, $TglSkrang <br>KA PRODI $prodi</td>
            </tr>
            <tr>
