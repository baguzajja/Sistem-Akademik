...
global $today,$BulanIni,$TahunIni;
 $s = "SELECT * FROM mahasiswa a,keuanganmhsw b WHERE a.NoReg=b.RegID AND b.IdentitasID='$_SESSION[Identitas]' AND b.Aktif='Y' AND b.Keterangan!='' AND b.RegID='$_GET[md]'";
 $w = _query($s);
 $r = _fetch_array($w);
 $NREG=$r[RegID];
...
<div class='row-fluid'>
<div class='pull-left'>
	<h4 style='margin-bottom: 0;margin-top: 5px;'><i class='icon-hand-right'></i>&nbsp;&nbsp;Detail Keuangan Mahasiswa </h4>
</div>
<div class='pull-right'>
	<div class='btn-group'><a class='btn btn-danger' href='go-BauRekanan.html'><i class='icon-undo'></i>Kembali</a>
</div>
</div>
</div></div>
