...
$s="SELECT * FROM transaksi a, detailbayarrekanan b WHERE a.TransID=b.transID AND a.TransID='$trans'";
...
$rek = GetFields('rekanan', 'RekananID', $d['RekananID'], '*');
            ...
            <td style='width: 100%'>
                <div class='zone' style='height: 28mm;position: relative;font-size: 5mm;'>
					...
					<div style='position: absolute; right: 3mm; top: 3mm; text-align: right; font-size: 4mm; '>
                        <i>Pembayaran Rekanan - ID : $trans</i><br><br><br><br>
						<span><i> Nama Rekanan : $rek[NamaRekanan]</i></span><br>
						<span><i> Bayar Untuk : $d[qty] mahasiswa</i></span><br>
                    </div>
