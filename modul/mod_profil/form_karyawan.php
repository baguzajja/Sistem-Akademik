...
global $TahunIni, $saiki;
 $w = GetFields('karyawan', 'username', $_SESSION[yapane], '*');
	$jdl = "<i class='icon-pencil'></i> PROFILE STAFF";
	$btn = "UPDATE";
...
<div class='control-group'>
	...
	<div class='controls'>
		<select name='identitas' class='input-xxlarge' disabled>";
...
<div class='control-group'>
	...
	<div class='controls'>
		<select name='Jbtn' class='input-xxlarge' disabled>
...
<div class='btn-group'>
	<input class='btn btn-success btn-large' type=submit value='$btn' name='simpanStaff'>
</div>
</div>
</fieldset></form>";
?>					
...
?>		
		...
		<input class='btn btn-success' type='submit' name='UploadStaff' value='Upload Foto'>
</div></form></div></div> 		 		
</div> 
<?php }else{
ErrorAkses();
