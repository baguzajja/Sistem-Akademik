...
$id = $_REQUEST['id'];
$r = GetFields('mahasiswa', 'NIM', $_SESSION[yapane], '*');
...
<div class="row">
			<div class="span8">
				...
				<div class="widget-header">
					<h3><i class="icon-pencil"></i>PROFILE MAHASISWA</h3>
...
<div class='control-group'>
		<div class='row-fluid'>
				<div class='span12'>
					...
					<div class='controls'><input type=text name=TempatLahir class='' value='$r[TempatLahir]' placeholder='Tempat Lahir..'>  ";
...
<div class='control-group'><div class='row-fluid'><div class='span12'>
		...
		<div class='controls'>
			<select name='institusi' class='span12' readonly>
...
<div class='control-group'><div class='row-fluid'><div class='span12'>
		...
		<div class='controls'>
			<select name='prodi' class='span12' readonly>
...
<div class='control-group'><div class='row-fluid'><div class='span12'>
		...
		<div class='controls'>
			<select name='kelas' class='span12' readonly>
...
<div class='control-group'><div class='row-fluid'><div class='span12'>
		...
		<div class='controls'>
			<select name='kons' class='span12' readonly>
...
<div class='control-group'><div class='row-fluid'>
	<div class='span6'>
			...
			<div class='controls'>
				<select name='StatusAwal_ID' class='span12' readonly>
	...
	<div class='span6'>
			...
			<div class='controls'>
				<select name='StatusMhsw_ID' class='span12' readonly>
...
?>
	...
	<div class='widget-toolbar'>
		<center>
		<input class='btn btn-success btn-large' type='submit' name='UpdateMhs' value='Update Data Mahasiswa'>
		</center>
	</div>
</form>
...
?>		
		...
		<input class='btn btn-success' type='submit' name='UploadMhs' value='Upload Foto'>
</div></form></div></div> 	
